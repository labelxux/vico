...
T = {
    ...
    "VICO היא האיטלקייה השכונתית בהרצליה. פיצות מהטאבון, פסטה טרייה, מנות לחלוקה, יין וקוקטיילים. ישיבה במקום וטייק אוויי.": "VICO is Herzliya's neighborhood Italian. Wood-fired pizza, fresh pasta, dishes to share, wine and cocktails. Dine in or takeaway.",
    "מסעדה איטלקית כשרה בהרצליה — פיצות מהטאבון, פסטה טרייה, מנות לחלוקה, יין וקוקטיילים. ישיבה במקום וטייק אוויי.": "Kosher Italian restaurant in Herzliya — wood-fired pizza, fresh pasta, dishes to share, wine and cocktails. Dine in or takeaway.",
    "VICO | האיטלקייה השכונתית בהרצליה": "VICO | Herzliya's Neighborhood Italian",
    "פיצה מהטאבון, פסטה טרייה ויין טוב. ישיבה במקום וטייק אוויי. כשר.": "Wood-fired pizza, fresh pasta and good wine. Dine in or takeaway. Kosher.",
    ...
    "עבודת יד, טאבון חם ושולחן שכיף להישאר סביבו.": "Handmade pasta, a hot oven and a table worth lingering at.",
    ...
    # ---- dishes ----
    "מה אוכלים היום?": "What's on today?",
    "משהו טוב מחכה על השולחן.": "Something good is waiting on the table.",
    ...
    # ---- takeaway ----
    "VICO אצלכם בבית.": "VICO at your place.",
    "פיצה מהטאבון, פסטה טרייה, סלטים וכל מה שטוב ליד — אורזים חם ומחכים לכם באבן עזרא 17.": "Wood-fired pizza, fresh pasta, salads and everything that goes with them — packed hot and waiting for you at 17 Even Ezra.",
    "הזמנה אונליין בלבד": "Online ordering only",
    "איסוף מהמסעדה": "Pick up at the restaurant",
    "מוגש בחום ואהבה": "Served hot, with love",
    "להזמנה אונליין": "Order online",
    "שאלות, הזמנת מקום, קבוצות או אירוע?": "Questions, reservations, groups or an event?",

    # ---- atmosphere ----
    "אצל VICO": "At VICO",
    "באים לפיצה,<br>נשארים לעוד כוס.": "Come for the pizza,<br>stay for another glass.",
    "VICO היא האיטלקייה של השכונה. מקום לקפוץ אליו למשולש, לפתוח שולחן עם פסטה ופיצה, או להישאר לעוד בקבוק יין בערב. מהצהריים עם הילדים ועד הלילה בטרסה.": "VICO is the neighborhood's Italian. A place to drop in for a slice, open a table of pasta and pizza, or stay for another bottle of wine in the evening. From lunch with the kids to late night on the terrace.",
    "גלריית VICO": "VICO gallery",

    # ---- bar ----
    "כוס יין. קוקטייל. ועוד אחד.": "A glass of wine. A cocktail. And one more.",
    "יינות ישראליים בכוס או בבקבוק, בירה קרה מהבקבוק וארבעה קוקטיילים שהבר שלנו רוקח בכל ערב. הטרסה מחכה.": "Israeli wines by the glass or bottle, cold bottled beer and four cocktails our bar mixes every evening. The terrace is waiting.",
    ...
    "טקילה בצ׳ילי, פסיפלורה והדרים. טרופי, חמצמץ עם קיק חריף!": "Chili tequila, passion fruit and citrus. Tropical, tangy, with a spicy kick!",
    "טקילה בצ׳ילי, פסיפלורה והדרים. טרופי, חמצמץ עם קיק חריף": "Chili tequila, passion fruit and citrus. Tropical, tangy, with a spicy kick",
    "וודקה, סמבוק, ענבי מרלו ולימון. פרחוני, פירותי ומרענן": "Vodka, elderflower, Merlot grapes and lemon. Floral, fruity and refreshing",
    "ג׳ין וסאקה, דובדבן, יוזו ולימון. פירותי, חמצמץ ורענן": "Gin and sake, cherry, yuzu and lemon. Fruity, tart and fresh",
    "ג׳ין, קמפרי והדרים. מריר, הדרי ומאוזן": "Gin, Campari and citrus. Bitter, citrusy and balanced",
    ...
    "— מנות ילדים עם ירקות ושתייה": "— kids’ dishes with veggies and a drink",
    "— FUOCO!, La Dolce Vita, זיכרונות מיפן ו־Amaro Amore": "— FUOCO!, La Dolce Vita, Japanese Memories and Amaro Amore",
    "— מוני ואדיר בכוס או בבקבוק, ובירה קרה ליד": "— Mony and Adir by the glass or bottle, with a cold beer on the side",
    ...
    # ---- club ----
    "כבר חברים?": "Already friends?",
    "הצטרפו למועדון החברים שלנו וקבלו הטבות, פינוקים ועדכונים על כל מה שקורה אצלנו.": "Join our members' club for perks, treats and updates on everything happening here.",
    "מתנת הצטרפות": "Welcome gift",
    "10% הנחה בהזמנה הראשונה": "10% off your first order",
    "מתנת יום הולדת": "Birthday gift",
    "קינוח מתנה לבחירה": "A dessert of your choice, on us",
    "מתנת יום נישואין": "Anniversary gift",
    "2 כוסות יין הבית / בירה מהחבית": "2 glasses of house wine / draft beer",
    "ובנוסף צבירת נקודות בכל הזמנה למימוש בהזמנות הבאות.": "Plus points on every order, to redeem next time.",
    ...
    "להזמנת מקום, קבוצות ואירועים": "Reservations, groups and events",
    ...
    "התפריט המלא של VICO בהרצליה: אנטיפסטי, סלטים, פיצות מהטאבון, פסטה טרייה, מנות ילדים, קינוחים, יין, קוקטיילים ובירה. כשר. ישיבה במקום או טייק אוויי.": "VICO's full menu in Herzliya: antipasti, salads, wood-fired pizza, fresh pasta, kids' dishes, desserts, wine, cocktails and beer. Kosher. Dine in or takeaway.",
    ...
    "זה התפריט. בוחרים, מזמינים מהצוות, ונשארים כמה שבא לכם.": "This is the menu. Pick, order with the team, and stay as long as you like.",
    "איך מגיעים": "Directions",
    "רעבים בבית?": "Hungry at home?",
    "כל המנות זמינות גם ל־Takeaway. מזמינים אונליין, אוספים חם.": "Every dish is available for takeaway. Order online, pick up hot.",
    "להזמנה ←": "Order →",
    ...
    "פוקאצ׳ה חמה, שמן זית ובלסמי, סוכריות שום קונפי וסלסת עגבניות": "Warm focaccia, olive oil and balsamic, garlic confit candies and tomato salsa",
    "זוקיני, גילופי פרמזן, צנובר, נענע, לימון ושמן זית": "Zucchini, parmesan shavings, pine nuts, mint, lemon and olive oil",
    "זוקיני נענע": "Mint Zucchini",
    "חסה, בצל סגול, צנונית ופטה, ברוטב ויניגרט": "Lettuce, red onion, radish and feta, in a vinaigrette",
    ...
    "מרגריטה": "Margherita",
    "חריפה": "Spicy",
    "רוטב עגבניות, מוצרלה, בולגרית, קלמטה, בצל וזעתר טרי": "Tomato sauce, mozzarella, Bulgarian cheese, Kalamata olives, onion and fresh za'atar",
    "יוונית": "Greek",
    "בצלים": "Onion",
    "בצק שחור, רוטב שמנת, מוצרלה, שמפיניון ושימג׳י, שמן כמהין": "Black dough, cream sauce, mozzarella, champignon and shimeji mushrooms, truffle oil",
    "שחורה": "Black",
    "פסטה טרייה, רוטב לבחירה: עגבניות, רוזה או שמנת": "Fresh pasta, your choice of sauce: tomato, rosa or cream",
    "הקלאסית": "The Classic",
    ...
    "מנת פסטה קטנה, רוטב לבחירה: עגבניות, רוזה או שמנת, ירקות ושתייה": "Small pasta, your choice of sauce: tomato, rosa or cream, veggies and a drink",
    "חצי פיצה מרגריטה, ירקות ושתייה": "Half a Margherita, veggies and a drink",
    "מגולגלות נוטלה חמות מהטאבון בליווי קצפת": "Warm Nutella rolls from the oven, served with whipped cream",
    ...
    "הבר": "The Bar",
    ">בר<": ">Bar<",
    "המסעדה כשרה ✦ המחירים בש״ח וכוללים מע״מ ✦ התפריט מתעדכן מדי פעם": "Kosher restaurant ✦ Prices in ILS, VAT included ✦ The menu changes from time to time",
    "נשאר רק לבחור.": "All that's left is to choose.",
    ...
    "באים לבשל איתנו? VICO מגייסת": "Come cook with us? VICO is hiring",
    "אנחנו מחפשים אנשים עם תשוקה לאוכל, לאירוח ולחיוכים. אם אתם מעל גיל 18, מתאימה לכם עבודה במשמרות ובא לכם להיות חלק מהצוות של האיטלקייה השכונתית של הרצליה — דברו איתנו.": "We're looking for people with a passion for food, hospitality and smiles. If you're over 18, shift work suits you and you'd like to be part of the team at Herzliya's neighborhood Italian — talk to us.",
    "עובדים איתנו": "Work with us",
    "שלחו וואטסאפ": "Send a WhatsApp",
    "%D7%94%D7%99%D7%99%2C%20%D7%90%D7%A0%D7%99%20%D7%9E%D7%AA%D7%A2%D7%A0%D7%99%D7%99%D7%9F%2F%D7%AA%20%D7%9C%D7%A2%D7%91%D7%95%D7%93%20%D7%91-VICO": "Hi%2C%20I%27m%20interested%20in%20working%20at%20VICO",
    "₪": "₪",
}
