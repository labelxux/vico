...
(function () {
  ...
  var P = EN ? "/en" : "";
  var S = EN ? {
    label: "VICO details", kosher: "Kosher ✦ Herzliya", nav: "Footer navigation", menu: "Menu",
    ...
    label: "פרטי VICO", kosher: "כשר ✦ הרצליה", nav: "ניווט תחתון", menu: "תפריט",
    club: "המועדון", insta: "אינסטגרם", address: "אבן עזרא 17, הרצליה", hours: "א׳–ה׳ 12:00–23:00",
      ...
      '<div class="footer__inner">' +
        '<div class="footer__brand">' +
          ...
          '<div class="footer__meta">' +
            '<div dir="ltr" lang="en">Pizza · Pasta · Wine</div>' +
            '<div>' + S.kosher + '</div>' +
          '</div>' +
        '</div>' +
        ...
        '<div class="footer__legal">' +
          '<a href="/accessibility/"' + (EN ? ' hreflang="he"' : '') + '>' + S.a11y + (EN ? ' (Hebrew)' : '') + '</a>' +
